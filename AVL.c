...
// Recursive function to insert a key in the subtree rooted with node and returns new root
...
int main() {
    ...
    // Insert nodes (automatically balanced)
    root = insert(root, 10);
    root = insert(root, 20);
    root = insert(root, 30);
    root = insert(root, 40);
    ...
    // Print in-order traversal of the balanced AVL Tree
